Shader "Hidden/TerrainTracesStandardAddPass" 
{
	Properties 
	{
	...
	SubShader 
	{
		...
		CGPROGRAM
		#pragma surface SurfaceShader Standard decal:add vertex:VSMain finalcolor:FinalColor finalgbuffer:FinalGBuffer addshadow fullforwardshadows noinstancing
